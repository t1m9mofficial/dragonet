<div class="content-wrapper">
    <h3>Bills
        <small>Showing Bills of <?php echo $month . ', ' . $year; ?></small>
    </h3>
    <div class="row">
        <div class="col-sm-9">
                ...
                <div class="panel-body">
                    <table id="datatable1" class="table table-striped table-hover">
                        ...
                        <?php
                            ...
                            $bill_info = $this->db->get_where('bill', array('month' => $month, 'year' => $year))->result_array();
        ...
        <div class="col-sm-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo base_url(); ?>index.php?admin/single_month_bill/" role="form" method="post">
